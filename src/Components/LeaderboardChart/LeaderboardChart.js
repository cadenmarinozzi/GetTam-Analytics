...
class LeaderboardChart extends Component {
	...
	async componentDidMount() {
		...
		try {
			...
			leaderboard = leaderboard.reverse(); // We reverse the data so it's in descending order
			const labels = leaderboard.map(player => player); // No need for sorting since the leaderboard is presorted
